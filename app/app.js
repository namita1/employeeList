...
app.controller('editCtrl', function ($scope, $rootScope, $location, $routeParams, services, customer) {
    ...
    $rootScope.title = (customerID > 0) ? 'Edit Employee' : 'Add Employee';
    $scope.buttonText = (customerID > 0) ? 'Update Employee' : 'Add New Employee';
      ...
      $scope.deleteCustomer = function(customer) {
        $location.path('/');
        if(confirm("Are you sure to delete employee number: "+$scope.customer._id)==true)
